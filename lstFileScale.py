...
from PyQt5.QtWidgets import QApplication, QMainWindow, QVBoxLayout, QWidget, QPushButton,\
      QTextEdit, QLabel, QFileDialog, QTableWidget, QTableWidgetItem, QHeaderView
# ,QDateTime
...
class MainWindow(QMainWindow):
    ...
    def adjust_column_widths(self):
        ...
        header.setSectionResizeMode(0, QHeaderView.ResizeToContents)  # 自动调整文件名列宽度
        header.setSectionResizeMode(1, QHeaderView.ResizeToContents)  # 自动调整大小列宽度
        header.setSectionResizeMode(2, QHeaderView.ResizeToContents)  # 自动调整创建时间列宽度
        header.setSectionResizeMode(3, QHeaderView.ResizeToContents)  # 自动调整修改时间列宽度
        header.setSectionResizeMode(4, QHeaderView.ResizeToContents)  # 自动调整类型列宽度
